...
void MainWindow::on_deletion_button_clicked()       { set_expressions("deletion");          }

void MainWindow::on_comma_button_clicked()          { set_expressions("add_comma");         }
void MainWindow::on_neg_pos_button_clicked()        { set_expressions("neg_pos");           }

void MainWindow::on_one_div_x_clicked()             { set_expressions("dif_op", "one_div"); }
void MainWindow::on_power_button_clicked()          { set_expressions("dif_op","sqr");      }
void MainWindow::on_sqrt_button_clicked()           { set_expressions("dif_op","sqrt");     }
